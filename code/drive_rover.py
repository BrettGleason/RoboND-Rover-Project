...
class RoverState():
    def __init__(self):
        ...
        self.start_pos = None # To record starting position
        ...
        self.narrow_angles = None # Angles of navigable terrain within FOV threshold
        self.nav_angles = None # Distances of navigable terrian within FOV threshold
